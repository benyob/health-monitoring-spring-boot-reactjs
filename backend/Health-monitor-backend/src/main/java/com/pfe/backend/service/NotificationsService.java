...
//		System.out.println(s);
	...
	// Blood Pressrure
	@Async
	public Future<Notification> getNotificationBloodPressure(List data, float refMinSyst ,float refMinDiast, float refMaxSyst ,float refMaxDiast)
			throws InterruptedException {
...
//		System.out.println(s);
		...
		String a, b, c, d, e;
			...
			a="Your Blood Pressure Levels Are Verry LOW !";
			b="Your Blood Pressure Levels Are Verry HIGH !";
			...
			if (n == null) return new AsyncResult<>(null);
